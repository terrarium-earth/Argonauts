package earth.terrarium.odyssey_guilds.client.fabric;
...
public class OdysseyGuildsClientFabric implements ClientModInitializer {

    @Override
    public void onInitializeClient() {
        OdysseyGuildsClient.init();
        ClientTickEvents.START_CLIENT_TICK.register(client -> OdysseyGuildsClient.clientTick());
        ClientPlayConnectionEvents.DISCONNECT.register((handler, client) -> OdysseyGuildsClient.onPlayerLoggedOut());
        KeyBindingHelper.registerKeyBinding(OdysseyGuildsClient.KEY_OPEN_PARTY_CHAT);
        KeyBindingHelper.registerKeyBinding(OdysseyGuildsClient.KEY_OPEN_GUILD_CHAT);
