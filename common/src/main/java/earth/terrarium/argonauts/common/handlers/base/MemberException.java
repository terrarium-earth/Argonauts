...
public class MemberException extends Exception {
    ...
    public static final MemberException CANT_SET_LEADER_TO_NON_PARTY_MEMBER = new MemberException(Component.translatable("command.argonauts.exception.cant_set_leader_to_non_party_member"));
    public static final MemberException CANT_SET_LEADER_TO_CURRENT_LEADER = new MemberException(Component.translatable("command.argonauts.exception.cant_set_leader_to_current_leader"));
    ...
    public static final MemberException CANT_SET_OWNER_TO_NON_GUILD_MEMBER = new MemberException(Component.translatable("command.argonauts.exception.cant_set_owner_to_non_guild_member"));
    public static final MemberException CANT_SET_OWNER_TO_CURRENT_OWNER = new MemberException(Component.translatable("command.argonauts.exception.cant_set_owner_to_current_owner"));
