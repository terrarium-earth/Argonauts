...
public class ConstantComponents {
    ...
    public static final Component GUILD_SETTING_TITLE = Component.translatable("gui.argonauts.guild_settings.title");
    ...
    public static final Component MOTD_1 = Component.translatable("text.argonauts.member.motd_1");
    public static final Component MOTD_2 = Component.translatable("text.argonauts.member.motd_2");
