package earth.terrarium.odyssey_allies.client.rendering;
...
public class UrlTexture extends SimpleTexture {
    ...
    private static final ResourceLocation DEFAULT_TEXTURE = OdysseyAllies.id("textures/gui/hourglass.png");
    ...
    public static ResourceLocation getTextureId(String url) {
        return OdysseyAllies.id("urlimages/" + Hashing.sha1().hashUnencodedChars(url));
    }
