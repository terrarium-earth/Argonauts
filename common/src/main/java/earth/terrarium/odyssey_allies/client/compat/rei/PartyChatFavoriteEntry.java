...
public class PartyChatFavoriteEntry extends BaseFavoriteEntry {
    ...
    public static final ResourceLocation ID = OdysseyAllies.id("party_chat");
    private static final ResourceLocation TEXTURE = OdysseyAllies.id("textures/gui/icons/teamwork.png");
