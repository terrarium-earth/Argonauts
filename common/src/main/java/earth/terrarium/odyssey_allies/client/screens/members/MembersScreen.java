...
import earth.terrarium.odyssey_allies.client.screens.entries.CommandEntry;
import earth.terrarium.odyssey_allies.client.screens.entries.DividerEntry;
import earth.terrarium.odyssey_allies.client.screens.entries.TextEntry;
import earth.terrarium.odyssey_allies.client.screens.settings.SettingList;
...
public class MembersScreen extends BaseScreen {
    ...
    private void addSettingsContent(SettingList list, GameProfile profile, Member member) {
        ...
        this.permissions.forEach(permission -> {
            Component title = Component.translatable("permission.odyssey_allies." + permission);
            Component description = Component.translatable("permission.odyssey_allies." + permission + ".description");
