package earth.terrarium.odyssey_allies.client.screens.settings;
...
import earth.terrarium.odyssey_allies.api.teams.settings.types.BooleanSetting;
import earth.terrarium.odyssey_allies.client.screens.BaseScreen;
import earth.terrarium.odyssey_allies.client.screens.entries.BooleanEntry;
import earth.terrarium.odyssey_allies.client.screens.entries.DividerEntry;
import earth.terrarium.odyssey_allies.client.screens.entries.StringEntry;
...
public class SettingsScreen extends BaseScreen {
    ...
    private static final ResourceLocation CONTAINER_BACKGROUND = OdysseyAllies.id("textures/gui/settings.png");
    ...
    protected void init() {
        ...
        this.settings.forEach((id, setting) -> {
            if (!setting.hidden()) {
                Component title = Component.translatable("setting.odyssey_allies." + id);
                Component description = Component.translatable("setting.odyssey_allies." + id + ".description");
