package earth.terrarium.odyssey_allies.common.chat;
...
import earth.terrarium.odyssey_allies.common.network.packets.ClientboundSendMessagePacket;
...
public class ChatHandler {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("Odyssey Allies Chat");
        ...
        if (level.isClientSide()) {
            ...
            team.onlineMembers(level).forEach(member -> {
                if (team.isMember(member.getUUID())) {
                    Component messageComponent = CommonUtils.serverTranslatable("chat.odyssey_allies.message",
