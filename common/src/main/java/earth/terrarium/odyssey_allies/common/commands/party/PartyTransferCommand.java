...
public final class PartyTransferCommand {
    ...
    private static void transfer(CommandSourceStack source, ServerPlayer targetPlayer) throws CommandSyntaxException {
        ...
        source.sendSuccess(() -> ModUtils.translatableWithStyle("command.odyssey_allies.transfer_party", targetPlayer.getName()), false);
        targetPlayer.displayClientMessage(ModUtils.translatableWithStyle("command.odyssey_allies.now_party_owner", party.displayName()), false);
    }
}
