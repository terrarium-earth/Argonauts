package earth.terrarium.odyssey_guilds.client.rendering;
...
public class UrlTexture extends SimpleTexture {
    ...
    private static final ResourceLocation DEFAULT_TEXTURE = OdysseyGuilds.id("textures/gui/hourglass.png");
    ...
    public static ResourceLocation getTextureId(String url) {
        return OdysseyGuilds.id("urlimages/" + Hashing.sha1().hashUnencodedChars(url));
    }
