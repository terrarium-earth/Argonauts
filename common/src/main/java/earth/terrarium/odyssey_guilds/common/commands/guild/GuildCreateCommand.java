...
public final class GuildCreateCommand {
    ...
    private static void create(CommandSourceStack source, String name) throws CommandSyntaxException {
        ...
        if (OdysseyGuilds.IS_ROLES_LOADED && !PrometheusCompat.hasPermission(player, ArgonautsPermissions.CREATE_GUILD)) throw TeamExceptions.NO_PERMISSION_CREATE_GUILD.create();
